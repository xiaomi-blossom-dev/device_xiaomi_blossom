...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi-service-lazy.blossom.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi-service-lazy.blossom
...
LOCAL_REQUIRED_MODULES := \
    android.hardware.wifi-service-lazy.blossom.rc
